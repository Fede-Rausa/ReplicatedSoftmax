...
This implementation is the first to use Mean Field Contrastive Divergence, Persistent Contrastive Divergence, L1/L2 penalization and gradient descent optimization (momentum, RMSprop, Adam, Adagrad)
